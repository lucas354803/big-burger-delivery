...
const tabelas = new Set(['categorias', 'produtos', 'complementos']);
...
function limparPayload(tabela, body) {
  ...
  if (tabela === 'complementos') return { nome: base.nome, preco: base.preco, ordem: base.ordem || 0, ativo: 'ativo' in body ? base.ativo : true };
  return base;
}
